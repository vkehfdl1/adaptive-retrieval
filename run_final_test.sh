...
# Path configurations
MODEL_CHECKPOINT="./checkpoint_without_score_dist/classification/last.ckpt"
...
SAVE_PATH="./ko-strategyqa-dev_trained_model_result_wo_dist_classification.parquet"
